...
internal static partial class CalendarEngineLogger
{
    ...
    public static partial void InfoCalendarSucceededUploadIcs(this ILogger<CalendarEngine> logger);
    ...
    [LoggerMessage(Level = LogLevel.Error, Message = "CalendarEngine->UploadIcsToCalendar with \r\n" +
                  ...
                  "Exception:\r\n{ex}\r\n")]
    public static partial void ErrorUploadIcsToCalendar(this ILogger<CalendarEngine> logger, int id, string uid, string ics, string charset, string contentType, string receiveEmail, Exception ex);
}
