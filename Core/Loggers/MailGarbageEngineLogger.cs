...
internal static partial class MailGarbageEngineLogger
{
    ...
    public static partial void ErrorMailGarbage(this ILogger logger, string error);
    ...
    public static partial void ErrorMailGarbageRemoveDomainFailed(this ILogger logger, string error);
    ...
    public static partial void ErrorMailGarbageGetTenantStatusFailed(this ILogger logger, int tenant, string error);
    ...
    public static partial void ErrorMailGarbageRemoveDomainIfUseless(this ILogger logger, string name, int id, string error);
    ...
    public static partial void InfoMailGarbageMailboxProcessedWithError(this ILogger logger, int mailboxId, string error);
    ...
    public static partial void DebugMailGarbageGetMessagesLimit(this ILogger logger, int? limit);
    ...
    public static partial void ErrorMailGarbageMailbox(this ILogger logger, int mailboxId, string error);
    ...
    public static partial void ErrorMailGarbageRemoveFile(this ILogger logger, string path, string error);
    ...
    public static partial void ErrorMailGarbageDeleteDirectory(this ILogger logger, string userMailDir, string error);
    ...
    public static partial void ErrorMailGarbageRemoveTLMailbox(this ILogger logger, int mailboxId, string error);

    [LoggerMessage(Level = LogLevel.Error, Message = "RemoveUserFolders() Failure\r\nException: {error}")]
    public static partial void ErrorMailGarbageRemoveUserFolders(this ILogger logger, string error);
    ...
    public static partial void ErrorMailGarbageRemoveMailboxData(this ILogger logger, int mailboxId, string error);
}
