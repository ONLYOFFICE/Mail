...
internal static partial class EmailInEngineLogger
{
    ...
    public static partial void ErrorEmailInEngineSaveEmailInData(this ILogger logger, int tenantId, string userId, int messageId, string error);
    ...
    public static partial void ErrorEmailInEngineUploadToDocuments(this ILogger logger, string fileName, string eMailInFolder, string error);
}
